 ...
 */
public class NewFoodItem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Add Food Details");
    ...
    try
    {
        ...
        stmt.executeUpdate("Insert into itemdetails values('"+code+"','"+name+"','"+type+"','"+price+"');");
        JOptionPane.showMessageDialog(this,"New Food Added Successfully");
    }    
         catch (Exception e)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewFoodItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
